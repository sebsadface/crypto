...
\begin{question}{Task 1 - Encryption Scheme (10 points)}
    \begin{part}
       \begin{answer}
            ...
            \hspace*{22pt} $x_i \leftarrow \pi(C[i])$ \\
    ...
    \begin{part}
        ...
        \hspace*{22pt} $M[1] = (\pi(0) - d -1 + 1)$ mod $10 = (\pi(0) - d)$ mod $10$, \\
        \hspace*{22pt} $M[2] = (\pi(0) - \pi(0) -1 + 2)$ mod $10 = (1)$ mod $10 = 1$, \\
        \hspace*{22pt} $M[3] = (\pi(0) - \pi(0) -1 + 3)$ mod $10 = (2)$ mod $10 = 2$, \\
        \hspace*{22pt} $M[4] = (\pi(0) - \pi(0) -1 + 4)$ mod $10 = (3)$ mod $10 = 3$, \\
        which give us: $M = (M[1],...,M[4]) = ( (\pi(0) - d)$ mod $10, 1, 2, 3 ) \ne (0,0,0,0) = M^*$ \\
...
%%%%%%%%%%%%%%%%%%%%%%%% Task 1 %%%%%%%%%%%%%%%%%%%%%%%%
\begin{question}{Task 3 - Playing with AES (10 points)}
    \begin{part}
       \begin{answer}
